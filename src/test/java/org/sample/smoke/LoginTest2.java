...
public class LoginTest2 extends BaseTest {
	...
	public void Setup() {
		...
		BrowserManager.getInstance().getContext().tracing()
	...
	public Object[][] portalCredentials() {
		return new Object[][] { { "Test Case1","student", "r9gdQ5BEzrFN6LImNzZHSATL3PYg97Bl", "with incorrect credentials" },
				{ "Test Case2", "student", "V2fcGf69cXD6chVeudHRLafV7X5Pn9p5", "with correct credentials" }, };
	}
